...
def RF_HD(end_data, test,num,train):
    ...
    for iter in range(len(end_data)):
        ...
        classification = list()
        for i in range(num):
            classification.append(RandomForestClassifier(n_estimators = 30))
        ...
        met = []
        under = UnderBaggingClassifier(base_estimator=RandomForestClassifier(n_estimators = 30))
        ...
        met = []
        bcc = BalanceCascadeClassifier(base_estimator=RandomForestClassifier(n_estimators = 30))
        ...
        # ===========================================BaggingClassifier======================
        met = []
        bc = BaggingClassifier(base_estimator=RandomForestClassifier(n_estimators = 30))
        ...
        met = []
        smb = SelfPacedEnsembleClassifier(base_estimator=RandomForestClassifier(n_estimators = 30))
        ...
        # ===========================================ResampleClassifier======================
        met = []
        rc = ResampleClassifier(base_estimator=RandomForestClassifier(n_estimators = 30))
        ...
        # ===========================================RUSBoostClassifier======================
        met = []
        rusb = RUSBoostClassifier(base_estimator=RandomForestClassifier(n_estimators = 30))
        ...
        met = []
        smo = SMOTEBaggingClassifier(base_estimator=RandomForestClassifier(n_estimators = 30))
